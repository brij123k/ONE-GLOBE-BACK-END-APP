...
export class StoreOptimizationDto {
  @IsIn(['title', 'description','metaTitle','metaDescription','handle','image','pricing','sku'])
  serviceName: 'title' | 'description' | 'metaTitle' | 'metaDescription' | 'handle' | 'image' | 'pricing' | 'sku';
